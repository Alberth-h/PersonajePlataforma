...
public class Player : MonoBehaviour
{
    ...
    void Start()
    {
        gameInputs.Gameplay.Jump.started += _ => Jump();
        gameInputs.Gameplay.Jump.canceled += _ => rb2D.velocity = Vector2.down;
        gameInputs.Gameplay.Jump.performed += _ => rb2D.velocity = Vector2.down;
